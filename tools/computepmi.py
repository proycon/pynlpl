...
def main():
    ...
    parser.add_argument('-u','--unidirectional', type=bool,help="Compute unidirectionally, i.e. the left word will always occur before the right word", action='store_true',default=False)
    parser.add_argument('-s','--sorted', type=bool,help="Output sorted by co-occurrence score", action='store_true',default=False)
    parser.add_argument('--pmi',type=bool,help="Compute pointwise mutual information", action='store_true',default=False)
    parser.add_argument('--npmi',type=bool,help="Compute normalised pointwise mutual information", action='store_true',default=False)
    ...
    for i, (pos, word) in enumerate(index):
        ...
        for pos2, word2 in index[sentence]:
